...
_lr_productions = [
  ...
  ('LIST -> LPAREN ELS RPAREN','LIST',3,'p_list','mistas_yacc.py',8),
  ('ELS -> ELS VIRG EL','ELS',3,'p_els_varias','mistas_yacc.py',11),
  ('ELS -> EL','ELS',1,'p_els_uma','mistas_yacc.py',14),
  ('EL -> NUM','EL',1,'p_el_num','mistas_yacc.py',17),
  ('EL -> BOOL','EL',1,'p_el_bool','mistas_yacc.py',20),
  ('EL -> ID','EL',1,'p_el_id','mistas_yacc.py',23),
]
